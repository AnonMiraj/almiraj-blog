...
const enableDarkMode = () => {
  ...
  document.body.classList.add("darkmode"); // keep body for safety
...
// Initial check is handled in head script to prevent FOUC
// But we should sync the state if needed (e.g. if script ran before body existed)
// Actually, the head script handles class addition. 

darkModeToggle.forEach((toggle) => {
  toggle.addEventListener("click", () => {
    let darkMode = localStorage.getItem("darkMode");
    
    // Check if currently enabled (class present on html)
    // This handles the "auto" case where localStorage is null but system is dark

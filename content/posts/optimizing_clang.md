+++
date = '2026-08-09'
title = 'Chasing Clang regressions'
+++
...
But finally, after three weeks of searching, I found an actual fixable one.
...
|10| [#213790](https://github.com/llvm/llvm-project/pull/213790) | avoid quadratic pack-indexing instantiation | O($N^2$)→O($N$): **~14.6× faster, ~31× less memory** at N=8k | ~0% |
...
My mentor Vassil put it better than I could:
